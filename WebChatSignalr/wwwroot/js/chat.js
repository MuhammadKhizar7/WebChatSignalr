...
//        unread: document.querySelector('.user-link.active').querySelector('.unread-count'),
    ...
    ExcerptEmoji: function () {
        ...
        if (Chat.el.excerpt.textContent) {
            Chat.el.excerpt.innerHTML =Chat.BasicEmojis.parseEmojis(Chat.el.excerpt.textContent);   
        }
    },
    BasicEmojis: {
    ...
    newShowNotification: function(roomId, message) {
        ...
        Ajax.makeRequest(url, options).then((data) => {
            ...
            if (data.response) {
                ...
                let notification =
                    `<li class="list-group-item list-group-item-action user-link " data-roomid="${roomId}" data-userid="${id}">
                               ...
                               <div class="media">
                                   ...
                                   <div class="media-body overflow-hidden">
                                       <div class="d-flex mb-1">
                                           ...
                                           <p class="small text-nowrap last-updated" datetime="${new Date()}">${window.timeago(new Date() - new Date())}</p>
                                       </div>
